...
import { Save, Calendar, MapPin, Users, Shield, Award, Settings, FileText, Clock, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-600">Configure tournament details visible to all users</p>
            </div>
          </div>
        </div>
        ...
        {message.text && (
          <div className={`mb-6 p-4 rounded-xl border-2 shadow-sm animate-fade-in ${
        ...
        <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-blue-900 mb-1">Public Visibility</h3>
              <p className="text-sm text-blue-700">
                All settings saved here will be immediately visible to users in the public portal. 
                Users can view tournament name, dates, location, rules, and limits in the Rules tab.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-1">Displayed as the main tournament title</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-1">Current tournament season or year</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-1">Main venue or district where tournament is held</p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'tournament' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900">Tournament Schedule</h2>
                <span className="text-xs bg-green-100 text-green-700 px-3 py-1 rounded-full font-semibold">
                  Visible to Users
                </span>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500 mt-1">When the tournament begins</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500 mt-1">When the tournament ends</p>
                </div>
              </div>
              ...
              {settings.startDate && settings.endDate && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-blue-900 mb-1">Tournament Duration</h3>
                      <p className="text-sm text-blue-700">
                        From <strong>{new Date(settings.startDate).toLocaleDateString('en-US', { 
                          month: 'long', 
                          day: 'numeric', 
                          year: 'numeric' 
                        })}</strong> to{' '}
                        <strong>{new Date(settings.endDate).toLocaleDateString('en-US', { 
                          month: 'long', 
                          day: 'numeric', 
                          year: 'numeric' 
                        })}</strong>
          ...
          {activeTab === 'rules' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900">Rules & Limitations</h2>
                <span className="text-xs bg-green-100 text-green-700 px-3 py-1 rounded-full font-semibold">
                  Visible to Users
                </span>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500 mt-1">Maximum number of teams allowed</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500 mt-1">Maximum players per team roster</p>
                </div>
              </div>
...
- Fair play expected from all teams"
                ...
                <p className="text-xs text-gray-500 mt-1">
                  These rules will be displayed to all users in the Rules tab. Be clear and comprehensive.
                </p>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700">
                      Rules are visible to all users and participants. Make sure they are clear, 
                      fair, and comprehensive. Users will see these in the public Rules section.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-600">
              Users see changes immediately after you save. No delay or manual refresh needed.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-600">
              All tournament info is publicly visible to users without requiring login.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-600">
              Rules appear in a dedicated Rules tab in the user portal with proper formatting.
            </p>
          </div>
        </div>
      </div>
